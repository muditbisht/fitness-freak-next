...
import { CONTENT_BLOCK_TYPE, QUESTION_TYPE, UserData } from "@/types";
...
interface FeedQuestionsProps {
    question: any;
    type: QUESTION_TYPE |  null;
    user: UserData|null;
    selectedCategories: string[];
    contentType: CONTENT_BLOCK_TYPE;
    bottomNeeded?: boolean;
}

export default function FeedQuestions({
    question, type, user, 
    selectedCategories=[], 
    ...
    */
    ...
    let url = "";
    if (type === QUESTION_TYPE.ANSWERASKED)
    ...
    return (
        <QuestionContainer>
            <Question>
                ...
                {contentType===CONTENT_BLOCK_TYPE.ANSER && <Answers quesId={question._id} />}
            </Question>
