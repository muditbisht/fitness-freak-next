...
export default function Searchbar({}){
    ...
    const [filterArr,setFilterArr]=useState<UserDataBase[]>([ ]);
    const filterDisplay = searchparam.length === 0;
    ...
    // }, [searchparam]);
        ...
        return (
            <InputDiv>
                ...
                <InputBase
                        ...
                        value={searchparam}
                        onBlur={f1}/>
                <div className="dd" style={{display: filterDisplay?'none':'block'}}>
        ...
        function fil(event: React.ChangeEvent<HTMLInputElement>){
                ...
                if(x==="") {
                    ...
                    axiosCall('POST', url, obj).then((res: any) => {
                        setFilterArr(res.data.users);
                    });
                } 
        }

        function addTag(el: UserDataBase){
            redirect(`/profile/${el._id}`);
        }
